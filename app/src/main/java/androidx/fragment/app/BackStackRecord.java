      ...
      if (m) {
        ...
        if (m != j) {
          for (j = paramInt1; j < paramInt2; j++) {
            ...
            for (n = 0; n < i1; n++) {
              int i2;
              FragmentTransaction.Op op1 = backStackRecord.mOps.get(n);
              if (op1.mFragment != null) {
                i2 = op1.mFragment.mContainerId;
              } else {
                i2 = 0;
              } 
              if (i2 == m)
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\fragment\app\BackStackRecord.class
