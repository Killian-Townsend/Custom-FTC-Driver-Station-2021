...
class FragmentManagerViewModel extends ViewModel {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (paramObject != null) {
      ...
      return (this.mRetainedFragments.equals(((FragmentManagerViewModel)paramObject).mRetainedFragments) && this.mChildNonConfigs.equals(((FragmentManagerViewModel)paramObject).mChildNonConfigs) && this.mViewModelStores.equals(((FragmentManagerViewModel)paramObject).mViewModelStores));
    } 
    return false;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\fragment\app\FragmentManagerViewModel.class
