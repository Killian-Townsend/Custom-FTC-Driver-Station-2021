    ...
    while (true) {
      ...
      if (k != 1) {
        ...
        if (m >= j || k != 3) {
          ...
          arrayOfInt4 = GrowingArrayUtils.append(arrayOfInt4, i, modulateColorAlpha(n, f));
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\core\content\res\ColorStateListInflaterCompat.class
