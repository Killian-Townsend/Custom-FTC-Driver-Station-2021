    ...
    if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 26) {
      ...
      if (arrayOfClickableSpan != null && arrayOfClickableSpan.length > 0) {
        ...
        for (int i = 0; arrayOfClickableSpan != null && i < arrayOfClickableSpan.length; i++) {
          int j = idForClickableSpan(arrayOfClickableSpan[i], sparseArray);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\core\view\accessibility\AccessibilityNodeInfoCompat.class
