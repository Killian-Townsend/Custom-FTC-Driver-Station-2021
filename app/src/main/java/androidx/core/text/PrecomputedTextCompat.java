...
public class PrecomputedTextCompat implements Spannable {
  ...
  public int getParagraphStart(int paramInt) {
    Preconditions.checkArgumentInRange(paramInt, 0, getParagraphCount(), "paraIndex");
    return (Build.VERSION.SDK_INT >= 29) ? this.mWrapped.getParagraphStart(paramInt) : ((paramInt == 0) ? 0 : this.mParagraphEnds[paramInt - 1]);
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\core\text\PrecomputedTextCompat.class
