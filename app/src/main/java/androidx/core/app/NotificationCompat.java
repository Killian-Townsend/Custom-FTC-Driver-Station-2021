...
public class NotificationCompat {
  ...
  static Action getActionCompatFromAction(Notification.Action paramAction) {
    ...
    if (arrayOfRemoteInput1 == null) {
      ...
      for (i = 0; i < arrayOfRemoteInput1.length; i++) {
        ...
        arrayOfRemoteInput[i] = new RemoteInput(str, charSequence, arrayOfCharSequence, bool1, bool, remoteInput.getExtras(), null);
      } 
    } 
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      ...
      return new Action(iconCompat, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), arrayOfRemoteInput, null, bool1, i, bool3, bool2);
    } 
    return new Action(paramAction.icon, paramAction.title, paramAction.actionIntent, paramAction.getExtras(), arrayOfRemoteInput, null, bool1, i, bool3, bool2);
  }
  ...
  public static final class CarExtender implements Extender {
    ...
    private static Bundle getBundleForUnreadConversation(UnreadConversation param1UnreadConversation) {
      ...
      int j = (param1UnreadConversation.getMessages()).length;
    ...
    private static UnreadConversation getUnreadConversationFromBundle(Bundle param1Bundle) {
      ...
      if (arrayOfString2 != null) {
        ...
        if (remoteInput != null) {
          ...
          remoteInput1 = new RemoteInput(str1, charSequence, arrayOfCharSequence, bool, i, remoteInput.getExtras(), null);
        } 
  ...
  public static abstract class Style {
    ...
    public RemoteViews applyStandardTemplate(boolean param1Boolean1, int param1Int, boolean param1Boolean2) {
      ...
      //   213: istore_2
      //   214: aload #9
      //   216: getstatic androidx/core/R$dimen.notification_small_icon_background_padding : I
      ...
      //   249: isub
      //   250: aload_0
      //   251: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   254: invokevirtual getColor : ()I
      //   257: invokespecial createIconWithBackground : (IIII)Landroid/graphics/Bitmap;
      //   260: astore #11
      //   262: aload #10
      //   264: getstatic androidx/core/R$id.right_icon : I
      //   267: aload #11
      //   269: invokevirtual setImageViewBitmap : (ILandroid/graphics/Bitmap;)V
      //   272: goto -> 298
      //   275: aload #10
      //   277: getstatic androidx/core/R$id.right_icon : I
      //   280: aload_0
      //   281: aload_0
      //   282: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   298: aload #10
      //   300: getstatic androidx/core/R$id.right_icon : I
      //   303: iconst_0
      ...
      //   311: ifeq -> 438
      //   314: aload_0
      //   315: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   318: getfield mNotification : Landroid/app/Notification;
      //   321: getfield icon : I
      //   324: ifeq -> 438
      //   327: aload #10
      //   329: getstatic androidx/core/R$id.icon : I
      //   332: iconst_0
      ...
      //   341: if_icmplt -> 415
      //   344: aload #9
      //   346: getstatic androidx/core/R$dimen.notification_large_icon_width : I
      //   349: invokevirtual getDimensionPixelSize : (I)I
      //   352: istore_2
      //   353: aload #9
      //   355: getstatic androidx/core/R$dimen.notification_big_circle_margin : I
      //   358: invokevirtual getDimensionPixelSize : (I)I
      //   361: istore #5
      //   363: aload #9
      //   365: getstatic androidx/core/R$dimen.notification_small_icon_size_as_large : I
      //   368: invokevirtual getDimensionPixelSize : (I)I
      //   371: istore #6
      //   373: aload_0
      //   374: aload_0
      //   375: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   388: iload #6
      //   390: aload_0
      //   391: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   394: invokevirtual getColor : ()I
      //   397: invokespecial createIconWithBackground : (IIII)Landroid/graphics/Bitmap;
      //   400: astore #11
      //   402: aload #10
      //   404: getstatic androidx/core/R$id.icon : I
      //   407: aload #11
      //   409: invokevirtual setImageViewBitmap : (ILandroid/graphics/Bitmap;)V
      //   412: goto -> 438
      //   415: aload #10
      //   417: getstatic androidx/core/R$id.icon : I
      //   420: aload_0
      //   421: aload_0
      //   422: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   438: aload_0
      //   439: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   442: getfield mContentTitle : Ljava/lang/CharSequence;
      //   445: ifnull -> 463
      //   448: aload #10
      //   450: getstatic androidx/core/R$id.title : I
      //   453: aload_0
      //   454: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   457: getfield mContentTitle : Ljava/lang/CharSequence;
      //   460: invokevirtual setTextViewText : (ILjava/lang/CharSequence;)V
      //   463: aload_0
      //   464: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   467: getfield mContentText : Ljava/lang/CharSequence;
      //   470: ifnull -> 494
      //   473: aload #10
      //   475: getstatic androidx/core/R$id.text : I
      //   478: aload_0
      //   479: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   502: if_icmpge -> 520
      //   505: aload_0
      //   506: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      ...
      //   521: istore_2
      //   522: aload_0
      //   523: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   526: getfield mContentInfo : Ljava/lang/CharSequence;
      //   529: ifnull -> 565
      //   532: aload #10
      //   534: getstatic androidx/core/R$id.info : I
      //   537: aload_0
      //   538: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   541: getfield mContentInfo : Ljava/lang/CharSequence;
      //   544: invokevirtual setTextViewText : (ILjava/lang/CharSequence;)V
      //   547: aload #10
      //   549: getstatic androidx/core/R$id.info : I
      //   552: iconst_0
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\core\app\NotificationCompat.class
