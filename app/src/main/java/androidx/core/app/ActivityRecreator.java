...
final class ActivityRecreator {
  ...
  static boolean recreate(Activity paramActivity) {
    ...
    if (performStopActivity2ParamsMethod == null && performStopActivity3ParamsMethod == null)
      return false; 
    try {
      final Object token = tokenField.get(paramActivity);
      if (object1 == null)
        return false; 
      ...
      final LifecycleCheckCallbacks callbacks = new LifecycleCheckCallbacks(paramActivity);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\core\app\ActivityRecreator.class
