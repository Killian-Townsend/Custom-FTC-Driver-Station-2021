...
public class Toolbar extends ViewGroup {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (shouldLayout((View)this.mNavButtonView)) {
      if (k) {
        ...
        i = layoutChildLeft((View)this.mNavButtonView, paramInt3, arrayOfInt, paramInt4);
        j = m;
      } 
    } else {
      i = paramInt3;
    ...
    if (shouldLayout((View)this.mCollapseButtonView))
      if (k) {
        ...
        paramInt1 = layoutChildLeft((View)this.mCollapseButtonView, i, arrayOfInt, paramInt4);
        paramInt2 = j;
      }  
    int j = paramInt1;
    int i = paramInt2;
    if (shouldLayout((View)this.mMenuView))
      if (k) {
        ...
        i = layoutChildRight((View)this.mMenuView, paramInt2, arrayOfInt, paramInt4);
        j = paramInt1;
      }  
    ...
    if (shouldLayout((View)this.mLogoView))
      if (k) {
        ...
        i = layoutChildLeft((View)this.mLogoView, paramInt1, arrayOfInt, paramInt4);
        paramInt2 = j;
      }  
    ...
    if (paramBoolean || bool) {
      ...
      if (k) {
        ...
        if (paramBoolean) {
          layoutParams1 = (LayoutParams)this.mTitleTextView.getLayoutParams();
          k = this.mTitleTextView.getMeasuredWidth() + i;
          m = this.mTitleTextView.getMeasuredHeight() + paramInt1;
          this.mTitleTextView.layout(i, paramInt1, k, m);
        ...
        if (bool) {
          ...
          m = this.mSubtitleTextView.getMeasuredWidth() + i;
          i2 = this.mSubtitleTextView.getMeasuredHeight();
          this.mSubtitleTextView.layout(i, paramInt1, m, i2 + paramInt1);
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (shouldLayout((View)this.mTitleTextView)) {
      measureChildCollapseMargins((View)this.mTitleTextView, paramInt1, i1 + i2, paramInt2, n, arrayOfInt);
    ...
    if (shouldLayout((View)this.mSubtitleTextView)) {
      j = Math.max(j, measureChildCollapseMargins((View)this.mSubtitleTextView, paramInt1, i1 + i2, paramInt2, k + n, arrayOfInt));
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\appcompat\widget\Toolbar.class
