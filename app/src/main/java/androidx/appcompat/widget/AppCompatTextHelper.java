  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (Build.VERSION.SDK_INT < 23) {
      ...
      if (tintTypedArray5.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
        colorStateList4 = tintTypedArray5.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
        colorStateList2 = colorStateList6;
        colorStateList3 = colorStateList5;
      } 
    } 
    ...
    int j = tintTypedArray3.getDimensionPixelSize(R.styleable.AppCompatTextView_lineHeight, -1);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\androidx\appcompat\widget\AppCompatTextHelper.class
