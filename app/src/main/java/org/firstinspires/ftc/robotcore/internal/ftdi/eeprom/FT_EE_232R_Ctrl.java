...
public class FT_EE_232R_Ctrl extends FT_EE_Ctrl {
  ...
  public FT_EE_232R_Ctrl(FtDevice paramFtDevice) {
    super(paramFtDevice);
  ...
  public short programEeprom(FT_EEPROM paramFT_EEPROM) {
    if (paramFT_EEPROM.getClass() != FT_EEPROM_232R.class)
      return 1; 
    int[] arrayOfInt = new int[80];
    FT_EEPROM_232R fT_EEPROM_232R = (FT_EEPROM_232R)paramFT_EEPROM;
    short s = 0;
    while (true) {
      if (s < 80) {
        try {
      ...
      arrayOfInt[0] = i;
      arrayOfInt[1] = fT_EEPROM_232R.VendorId;
      arrayOfInt[2] = fT_EEPROM_232R.ProductId;
      arrayOfInt[3] = 1536;
      ...
      if (fT_EEPROM_232R.InvertRI)
        j = i | 0x8000; 
      arrayOfInt[5] = j;
      arrayOfInt[10] = fT_EEPROM_232R.CBus0 | fT_EEPROM_232R.CBus1 << 4 | fT_EEPROM_232R.CBus2 << 8 | fT_EEPROM_232R.CBus3 << 12;
      arrayOfInt[11] = fT_EEPROM_232R.CBus4;
      i = setStringDescriptor(fT_EEPROM_232R.Manufacturer, arrayOfInt, 12, 7, true);
      i = setStringDescriptor(fT_EEPROM_232R.Product, arrayOfInt, i, 8, true);
      if (fT_EEPROM_232R.SerNumEnable)
        setStringDescriptor(fT_EEPROM_232R.SerialNumber, arrayOfInt, i, 9, true); 
  ...
  public FT_EEPROM readEeprom() {
    ...
    while (true) {
      ...
      if ((arrayOfInt[0] & 0x4) == 4) {
        ((FT_EEPROM_232R)exception).HighIO = true;
      } else {
        ((FT_EEPROM_232R)exception).HighIO = false;
      } 
      if ((arrayOfInt[0] & 0x8) == 8) {
        ((FT_EEPROM_232R)exception).LoadVCP = true;
      } else {
        ((FT_EEPROM_232R)exception).LoadVCP = false;
      } 
      if ((arrayOfInt[0] & 0x2) == 2) {
        ((FT_EEPROM_232R)exception).ExternalOscillator = true;
      } else {
        ((FT_EEPROM_232R)exception).ExternalOscillator = false;
      } 
      ((FT_EEPROM_232R)exception).VendorId = (short)arrayOfInt[1];
      ((FT_EEPROM_232R)exception).ProductId = (short)arrayOfInt[2];
      getUSBConfig((FT_EEPROM)exception, arrayOfInt[4]);
      getDeviceControl(exception, arrayOfInt[5]);
      if ((arrayOfInt[5] & 0x100) == 256) {
        ((FT_EEPROM_232R)exception).InvertTXD = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertTXD = false;
      } 
      if ((arrayOfInt[5] & 0x200) == 512) {
        ((FT_EEPROM_232R)exception).InvertRXD = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertRXD = false;
      } 
      if ((arrayOfInt[5] & 0x400) == 1024) {
        ((FT_EEPROM_232R)exception).InvertRTS = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertRTS = false;
      } 
      if ((arrayOfInt[5] & 0x800) == 2048) {
        ((FT_EEPROM_232R)exception).InvertCTS = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertCTS = false;
      } 
      if ((arrayOfInt[5] & 0x1000) == 4096) {
        ((FT_EEPROM_232R)exception).InvertDTR = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertDTR = false;
      } 
      if ((arrayOfInt[5] & 0x2000) == 8192) {
        ((FT_EEPROM_232R)exception).InvertDSR = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertDSR = false;
      } 
      if ((arrayOfInt[5] & 0x4000) == 16384) {
        ((FT_EEPROM_232R)exception).InvertDCD = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertDCD = false;
      } 
      if ((arrayOfInt[5] & 0x8000) == 32768) {
        ((FT_EEPROM_232R)exception).InvertRI = true;
      } else {
        ((FT_EEPROM_232R)exception).InvertRI = false;
      } 
      i = arrayOfInt[10];
      ((FT_EEPROM_232R)exception).CBus0 = (byte)(i & 0xF);
      ((FT_EEPROM_232R)exception).CBus1 = (byte)((i & 0xF0) >> 4);
      ((FT_EEPROM_232R)exception).CBus2 = (byte)((i & 0xF00) >> 8);
      ((FT_EEPROM_232R)exception).CBus3 = (byte)((i & 0xF000) >> 12);
      ((FT_EEPROM_232R)exception).CBus4 = (byte)(arrayOfInt[11] & 0xFF);
      ((FT_EEPROM_232R)exception).Manufacturer = getStringDescriptor(((arrayOfInt[7] & 0xFF) - 128) / 2, arrayOfInt);
      ((FT_EEPROM_232R)exception).Product = getStringDescriptor(((arrayOfInt[8] & 0xFF) - 128) / 2, arrayOfInt);
      ((FT_EEPROM_232R)exception).SerialNumber = getStringDescriptor(((arrayOfInt[9] & 0xFF) - 128) / 2, arrayOfInt);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\ftdi\eeprom\FT_EE_232R_Ctrl.class
