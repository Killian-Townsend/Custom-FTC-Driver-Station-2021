...
public class FT_EE_4232H_Ctrl extends FT_EE_Ctrl {
  ...
  public FT_EE_4232H_Ctrl(FtDevice paramFtDevice) throws FtDeviceIOException, RobotUsbException {
    super(paramFtDevice);
  ...
  public short programEeprom(FT_EEPROM paramFT_EEPROM) {
    ...
    if (paramFT_EEPROM.getClass() != FT_EEPROM_4232H.class)
      return 1; 
    FT_EEPROM_4232H fT_EEPROM_4232H = (FT_EEPROM_4232H)paramFT_EEPROM;
    arrayOfInt[0] = 0;
    try {
      boolean bool;
      ...
      if (fT_EEPROM_4232H.BL_LoadVCP)
        arrayOfInt[0] = arrayOfInt[0] | 0x80; 
      ...
      arrayOfInt[1] = fT_EEPROM_4232H.VendorId;
      arrayOfInt[2] = fT_EEPROM_4232H.ProductId;
      arrayOfInt[3] = 2048;
      arrayOfInt[4] = setUSBConfig(paramFT_EEPROM);
      arrayOfInt[5] = setDeviceControl(paramFT_EEPROM);
      if (fT_EEPROM_4232H.AL_LoadRI_RS485)
        arrayOfInt[5] = (short)(arrayOfInt[5] | 0x1000); 
      if (fT_EEPROM_4232H.AH_LoadRI_RS485)
        arrayOfInt[5] = (short)(arrayOfInt[5] | 0x2000); 
      if (fT_EEPROM_4232H.BL_LoadRI_RS485)
        arrayOfInt[5] = (short)(arrayOfInt[5] | 0x4000); 
      if (fT_EEPROM_4232H.BH_LoadRI_RS485)
        arrayOfInt[5] = (short)(arrayOfInt[5] | 0x8000); 
      arrayOfInt[6] = 0;
      ...
      b = fT_EEPROM_4232H.AH_DriveCurrent;
      i = b;
      if (b == -1)
        i = 0; 
      ...
      b = fT_EEPROM_4232H.BL_DriveCurrent;
      i = b;
      if (b == -1)
        i = 0; 
      ...
      arrayOfInt[6] = (short)(fT_EEPROM_4232H.BH_DriveCurrent << 12) | arrayOfInt[6];
      ...
      i = setStringDescriptor(fT_EEPROM_4232H.Manufacturer, arrayOfInt, i, 7, bool);
      i = setStringDescriptor(fT_EEPROM_4232H.Product, arrayOfInt, i, 8, bool);
      if (fT_EEPROM_4232H.SerNumEnable)
        setStringDescriptor(fT_EEPROM_4232H.SerialNumber, arrayOfInt, i, 9, bool); 
      i = fT_EEPROM_4232H.TPRDRV;
      if (i != 0) {
        if (i != 1) {
          if (i != 2) {
            if (i != 3) {
  ...
  public FT_EEPROM readEeprom() {
    ...
    try {
      ...
      if ((short)((arrayOfInt[0] & 0x80) >> 7) == 1) {
      ...
      if ((short)((arrayOfInt[0] & 0x8000) >> 15) == 1) {
      ...
      fT_EEPROM_4232H.VendorId = (short)arrayOfInt[1];
      fT_EEPROM_4232H.ProductId = (short)arrayOfInt[2];
      getUSBConfig(fT_EEPROM_4232H, arrayOfInt[4]);
      getDeviceControl(fT_EEPROM_4232H, arrayOfInt[5]);
    ...
    if (s1 != 0) {
      if (s1 != 1) {
        if (s1 != 2) {
          if (s1 == 3)
            ((FT_EEPROM_4232H)exception).AL_DriveCurrent = 3; 
        } else {
          ((FT_EEPROM_4232H)exception).AL_DriveCurrent = 2;
        } 
      } else {
        ((FT_EEPROM_4232H)exception).AL_DriveCurrent = 1;
      } 
    } else {
      ((FT_EEPROM_4232H)exception).AL_DriveCurrent = 0;
    } 
    if ((short)(arrayOfInt[6] & 0x4) == 4) {
      ((FT_EEPROM_4232H)exception).AL_SlowSlew = true;
    } else {
      ((FT_EEPROM_4232H)exception).AL_SlowSlew = false;
    } 
    if ((short)(arrayOfInt[6] & 0x8) == 8) {
      ((FT_EEPROM_4232H)exception).AL_SchmittInput = true;
    } else {
      ((FT_EEPROM_4232H)exception).AL_SchmittInput = false;
    } 
    ...
    if (s1 != 0) {
      if (s1 != 1) {
        if (s1 != 2) {
          if (s1 == 3)
            ((FT_EEPROM_4232H)exception).AH_DriveCurrent = 3; 
        } else {
          ((FT_EEPROM_4232H)exception).AH_DriveCurrent = 2;
        } 
      } else {
        ((FT_EEPROM_4232H)exception).AH_DriveCurrent = 1;
      } 
    } else {
      ((FT_EEPROM_4232H)exception).AH_DriveCurrent = 0;
    } 
    if ((short)(arrayOfInt[6] & 0x40) == 64) {
      ((FT_EEPROM_4232H)exception).AH_SlowSlew = true;
    } else {
      ((FT_EEPROM_4232H)exception).AH_SlowSlew = false;
    } 
    if ((short)(arrayOfInt[6] & 0x80) == 128) {
      ((FT_EEPROM_4232H)exception).AH_SchmittInput = true;
    } else {
      ((FT_EEPROM_4232H)exception).AH_SchmittInput = false;
    } 
    s1 = (short)((arrayOfInt[6] & 0x300) >> 8);
    if (s1 != 0) {
      if (s1 != 1) {
        if (s1 != 2) {
          if (s1 == 3)
            ((FT_EEPROM_4232H)exception).BL_DriveCurrent = 3; 
        } else {
          ((FT_EEPROM_4232H)exception).BL_DriveCurrent = 2;
        } 
      } else {
        ((FT_EEPROM_4232H)exception).BL_DriveCurrent = 1;
      } 
    } else {
      ((FT_EEPROM_4232H)exception).BL_DriveCurrent = 0;
    } 
    if ((short)(arrayOfInt[6] & 0x400) == 1024) {
      ((FT_EEPROM_4232H)exception).BL_SlowSlew = true;
    } else {
      ((FT_EEPROM_4232H)exception).BL_SlowSlew = false;
    } 
    if ((short)(arrayOfInt[6] & 0x800) == 2048) {
      ((FT_EEPROM_4232H)exception).BL_SchmittInput = true;
    } else {
      ((FT_EEPROM_4232H)exception).BL_SchmittInput = false;
    } 
    ...
    if (s1 != 0) {
      if (s1 != 1) {
        if (s1 != 2) {
          if (s1 == 3)
            ((FT_EEPROM_4232H)exception).BH_DriveCurrent = 3; 
        } else {
          ((FT_EEPROM_4232H)exception).BH_DriveCurrent = 2;
        } 
      } else {
        ((FT_EEPROM_4232H)exception).BH_DriveCurrent = 1;
      } 
    } else {
      ((FT_EEPROM_4232H)exception).BH_DriveCurrent = 0;
    } 
    if ((short)(arrayOfInt[6] & 0x4000) == 16384) {
      ((FT_EEPROM_4232H)exception).BH_SlowSlew = true;
    } else {
      ((FT_EEPROM_4232H)exception).BH_SlowSlew = false;
    } 
    if ((short)(arrayOfInt[6] & 0x8000) == 32768) {
      ((FT_EEPROM_4232H)exception).BH_SchmittInput = true;
    } else {
      ((FT_EEPROM_4232H)exception).BH_SchmittInput = false;
    } 
    s1 = (short)((arrayOfInt[11] & 0x18) >> 3);
    if (s1 < 4) {
      ((FT_EEPROM_4232H)exception).TPRDRV = s1;
    } else {
      ((FT_EEPROM_4232H)exception).TPRDRV = 0;
    } 
    int i = arrayOfInt[7] & 0xFF;
    if (this.mEepromType == 70) {
      ((FT_EEPROM_4232H)exception).Manufacturer = getStringDescriptor((i - 128) / 2, arrayOfInt);
      ((FT_EEPROM_4232H)exception).Product = getStringDescriptor(((arrayOfInt[8] & 0xFF) - 128) / 2, arrayOfInt);
      ((FT_EEPROM_4232H)exception).SerialNumber = getStringDescriptor(((arrayOfInt[9] & 0xFF) - 128) / 2, arrayOfInt);
      return (FT_EEPROM)exception;
    } 
    ((FT_EEPROM_4232H)exception).Manufacturer = getStringDescriptor(i / 2, arrayOfInt);
    ((FT_EEPROM_4232H)exception).Product = getStringDescriptor((arrayOfInt[8] & 0xFF) / 2, arrayOfInt);
    ((FT_EEPROM_4232H)exception).SerialNumber = getStringDescriptor((arrayOfInt[9] & 0xFF) / 2, arrayOfInt);
    return (FT_EEPROM)exception;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\ftdi\eeprom\FT_EE_4232H_Ctrl.class
