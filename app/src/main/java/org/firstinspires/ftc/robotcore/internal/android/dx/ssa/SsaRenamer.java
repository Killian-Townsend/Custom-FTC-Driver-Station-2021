...
public class SsaRenamer implements Runnable {
  ...
  private class BlockRenamer implements SsaInsn.Visitor {
    ...
    public void visitMoveInsn(NormalSsaInsn param1NormalSsaInsn) {
      RegisterSpec registerSpec2 = param1NormalSsaInsn.getResult();
      int i = registerSpec2.getReg();
      RegisterSpecList registerSpecList = param1NormalSsaInsn.getSources();
      boolean bool = false;
      int k = registerSpecList.get(0).getReg();
      param1NormalSsaInsn.mapSourceRegisters(this.mapper);
      int j = param1NormalSsaInsn.getSources().get(0).getReg();
      LocalItem localItem2 = this.currentMapping[k].getLocalItem();
      LocalItem localItem3 = registerSpec2.getLocalItem();
      LocalItem localItem1 = localItem3;
      if (localItem3 == null)
        localItem1 = localItem2; 
      localItem3 = SsaRenamer.this.getLocalForNewReg(j);
      if (localItem3 == null || localItem1 == null || localItem1.equals(localItem3))
        bool = true; 
      RegisterSpec registerSpec1 = RegisterSpec.makeLocalOptional(j, (TypeBearer)registerSpec2.getType(), localItem1);
      if (!Optimizer.getPreserveLocals() || (bool && SsaRenamer.equalsHandlesNulls(localItem1, localItem2) && SsaRenamer.this.threshold == 0)) {
        addMapping(i, registerSpec1);
        return;
      } 
      if (bool && localItem2 == null && SsaRenamer.this.threshold == 0) {
        RegisterSpecList registerSpecList1 = RegisterSpecList.make(RegisterSpec.make(registerSpec1.getReg(), (TypeBearer)registerSpec1.getType(), localItem1));
        SsaInsn ssaInsn = SsaInsn.makeFromRop((Insn)new PlainInsn(Rops.opMarkLocal((TypeBearer)registerSpec1), SourcePosition.NO_INFO, null, registerSpecList1), this.block);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dx\ssa\SsaRenamer.class
