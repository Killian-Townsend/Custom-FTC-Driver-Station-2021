...
public final class Form32x extends InsnFormat {
  ...
  public boolean isCompatible(DalvInsn paramDalvInsn) {
    RegisterSpecList registerSpecList = paramDalvInsn.getRegisters();
    return (paramDalvInsn instanceof org.firstinspires.ftc.robotcore.internal.android.dx.dex.code.SimpleInsn && registerSpecList.size() == 2 && unsignedFitsInShort(registerSpecList.get(0).getReg()) && unsignedFitsInShort(registerSpecList.get(1).getReg()));
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dx\dex\code\form\Form32x.class
