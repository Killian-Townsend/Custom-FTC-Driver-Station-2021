...
public final class TableOfContents {
  ...
  public TableOfContents() {
    ...
    this.sections = new Section[] { 
        this.header, this.stringIds, this.typeIds, this.protoIds, this.fieldIds, this.methodIds, this.classDefs, this.mapList, this.typeLists, this.annotationSetRefLists, 
        this.annotationSets, this.classDatas, this.codes, this.stringDatas, this.debugInfos, this.annotations, this.encodedArrays, section };
  ...
  private void readMap(Dex.Section paramSection) throws IOException {
    ...
    while (i < j) {
      ...
      if ((section1.size == 0 || section1.size == k) && (section1.off == -1 || section1.off == m)) {
        section1.size = k;
        section1.off = m;
  ...
  public void computeSizesFromOffsets() {
    int j = this.dataOff + this.dataSize;
    for (int i = this.sections.length - 1; i >= 0; i--) {
      Section section = this.sections[i];
      if (section.off != -1)
        if (section.off <= j) {
          section.byteCount = j - section.off;
          j = section.off;
        } else {
          StringBuilder stringBuilder = new StringBuilder();
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dex\TableOfContents.class
