...
public final class Annotation extends MutabilityControl implements Comparable<Annotation>, ToHuman {
  ...
  public boolean equals(Object paramObject) {
    ...
    return this.type.equals(((Annotation)paramObject).type) ? ((this.visibility != ((Annotation)paramObject).visibility) ? false : this.elements.equals(((Annotation)paramObject).elements)) : false;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dx\rop\annotation\Annotation.class
