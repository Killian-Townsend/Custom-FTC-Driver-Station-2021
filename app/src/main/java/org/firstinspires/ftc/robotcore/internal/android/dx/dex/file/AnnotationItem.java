...
public final class AnnotationItem extends OffsettedItem {
  ...
  protected void writeTo0(DexFile paramDexFile, AnnotatedOutput paramAnnotatedOutput) {
    ...
    int i = null.$SwitchMap$org$firstinspires$ftc$robotcore$internal$android$dx$rop$annotation$AnnotationVisibility[annotationVisibility.ordinal()];
    if (i != 1) {
      if (i != 2) {
        if (i == 3) {
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dx\dex\file\AnnotationItem.class
