...
public final class NormalSsaInsn extends SsaInsn implements Cloneable {
  ...
  public final void changeOneSource(int paramInt, RegisterSpec paramRegisterSpec) {
    ...
    int j = registerSpecList2.size();
    RegisterSpecList registerSpecList1 = new RegisterSpecList(j);
    for (int i = 0; i < j; i++) {
      RegisterSpec registerSpec1;
      if (i == paramInt) {
        registerSpec1 = paramRegisterSpec;
      } else {
        registerSpec1 = registerSpecList2.get(i);
      } 
      registerSpecList1.set(i, registerSpec1);
    } 
    registerSpecList1.setImmutable();
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\org\firstinspires\ftc\robotcore\internal\android\dx\ssa\NormalSsaInsn.class
