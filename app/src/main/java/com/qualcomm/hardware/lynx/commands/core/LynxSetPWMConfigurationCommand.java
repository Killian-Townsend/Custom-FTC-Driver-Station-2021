...
public class LynxSetPWMConfigurationCommand extends LynxDekaInterfaceCommand<LynxAck> {
  ...
  public LynxSetPWMConfigurationCommand(LynxModuleIntf paramLynxModuleIntf) {
    super(paramLynxModuleIntf);
  }
  
  public LynxSetPWMConfigurationCommand(LynxModuleIntf paramLynxModuleIntf, int paramInt1, int paramInt2) {
    this(paramLynxModuleIntf);
    LynxConstants.validatePwmChannelZ(paramInt1);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\qualcomm\hardware\lynx\commands\core\LynxSetPWMConfigurationCommand.class
