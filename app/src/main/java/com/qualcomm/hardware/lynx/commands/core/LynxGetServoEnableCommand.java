...
public class LynxGetServoEnableCommand extends LynxDekaInterfaceCommand<LynxGetServoEnableResponse> {
  ...
  public LynxGetServoEnableCommand(LynxModuleIntf paramLynxModuleIntf) {
    super(paramLynxModuleIntf);
    this.response = (LynxMessage)new LynxGetServoEnableResponse(paramLynxModuleIntf);
  }
  
  public LynxGetServoEnableCommand(LynxModuleIntf paramLynxModuleIntf, int paramInt) {
  ...
  public static Class<? extends LynxInterfaceResponse> getResponseClass() {
    return (Class)LynxGetServoEnableResponse.class;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\qualcomm\hardware\lynx\commands\core\LynxGetServoEnableCommand.class
