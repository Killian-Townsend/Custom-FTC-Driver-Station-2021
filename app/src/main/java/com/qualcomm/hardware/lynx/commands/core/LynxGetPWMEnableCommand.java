...
public class LynxGetPWMEnableCommand extends LynxDekaInterfaceCommand<LynxGetPWMEnableResponse> {
  ...
  public LynxGetPWMEnableCommand(LynxModuleIntf paramLynxModuleIntf) {
    super(paramLynxModuleIntf);
    this.response = (LynxMessage)new LynxGetPWMEnableResponse(paramLynxModuleIntf);
  }
  
  public LynxGetPWMEnableCommand(LynxModuleIntf paramLynxModuleIntf, int paramInt) {
  ...
  public static Class<? extends LynxInterfaceResponse> getResponseClass() {
    return (Class)LynxGetPWMEnableResponse.class;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\qualcomm\hardware\lynx\commands\core\LynxGetPWMEnableCommand.class
