...
public class LynxGetServoPulseWidthCommand extends LynxDekaInterfaceCommand<LynxGetServoPulseWidthResponse> {
  ...
  public LynxGetServoPulseWidthCommand(LynxModuleIntf paramLynxModuleIntf) {
    super(paramLynxModuleIntf);
    this.response = (LynxMessage)new LynxGetServoPulseWidthResponse(paramLynxModuleIntf);
  }
  
  public LynxGetServoPulseWidthCommand(LynxModuleIntf paramLynxModuleIntf, int paramInt) {
  ...
  public static Class<? extends LynxInterfaceResponse> getResponseClass() {
    return (Class)LynxGetServoPulseWidthResponse.class;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\qualcomm\hardware\lynx\commands\core\LynxGetServoPulseWidthCommand.class
