...
public class LynxIsMotorAtTargetCommand extends LynxDekaInterfaceCommand<LynxIsMotorAtTargetResponse> {
  ...
  public LynxIsMotorAtTargetCommand(LynxModuleIntf paramLynxModuleIntf) {
    super(paramLynxModuleIntf);
    this.response = (LynxMessage)new LynxIsMotorAtTargetResponse(paramLynxModuleIntf);
  }
  
  public LynxIsMotorAtTargetCommand(LynxModuleIntf paramLynxModuleIntf, int paramInt) {
  ...
  public static Class<? extends LynxInterfaceResponse> getResponseClass() {
    return (Class)LynxIsMotorAtTargetResponse.class;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\qualcomm\hardware\lynx\commands\core\LynxIsMotorAtTargetCommand.class
