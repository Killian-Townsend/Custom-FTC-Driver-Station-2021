...
public final class $Gson$Types {
  ...
  public static Type resolve(Type paramType1, Class<?> paramClass, Type<?> paramType2) {
    ...
    if (bool) {
      ...
      while (i < j) {
        Type type2 = resolve(paramType1, paramClass, arrayOfType1[i]);
        boolean bool2 = bool1;
    ...
    public ParameterizedTypeImpl(Type param1Type1, Type param1Type2, Type... param1VarArgs) {
      ...
      while (true) {
        ...
        if (i < arrayOfType.length) {
          $Gson$Preconditions.checkNotNull(arrayOfType[i]);
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\google\gson\internal\$Gson$Types.class
