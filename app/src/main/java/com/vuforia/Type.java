...
public class Type {
  ...
  protected static long getCPtr(Type paramType) {
    return (paramType == null) ? 0L : paramType.swigCPtr;
  }
  ...
  protected void delete() {
    ...
    //   27: invokestatic delete_Type : (J)V
    //   30: aload_0
    //   31: lconst_0
  ...
  public boolean equals(Object paramObject) {
    boolean bool = paramObject instanceof Type;
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bool) {
      bool1 = bool2;
      if (((Type)paramObject).swigCPtr == this.swigCPtr)
        bool1 = true; 
    } 
    return bool1;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\vuforia\Type.class
