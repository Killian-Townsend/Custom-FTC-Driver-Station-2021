...
public class ModelTargetResult extends ObjectTargetResult {
  ...
  protected static long getCPtr(ModelTargetResult paramModelTargetResult) {
    return (paramModelTargetResult == null) ? 0L : paramModelTargetResult.swigCPtr;
  }
  ...
  protected void delete() {
    ...
    //   27: invokestatic delete_ModelTargetResult : (J)V
    //   30: aload_0
    //   31: lconst_0
  ...
  public boolean equals(Object paramObject) {
    boolean bool = paramObject instanceof ModelTargetResult;
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bool) {
      bool1 = bool2;
      if (((ModelTargetResult)paramObject).swigCPtr == this.swigCPtr)
        bool1 = true; 
    } 
    return bool1;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\vuforia\ModelTargetResult.class
