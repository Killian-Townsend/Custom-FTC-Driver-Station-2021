...
public class ImageTarget extends ObjectTarget {
  ...
  protected static long getCPtr(ImageTarget paramImageTarget) {
    return (paramImageTarget == null) ? 0L : paramImageTarget.swigCPtr;
  }
  ...
  protected void delete() {
    ...
    //   27: invokestatic delete_ImageTarget : (J)V
    //   30: aload_0
    //   31: lconst_0
  ...
  public boolean equals(Object paramObject) {
    boolean bool = paramObject instanceof ImageTarget;
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bool) {
      bool1 = bool2;
      if (((ImageTarget)paramObject).swigCPtr == this.swigCPtr)
        bool1 = true; 
    } 
    return bool1;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\vuforia\ImageTarget.class
