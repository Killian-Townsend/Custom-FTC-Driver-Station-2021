...
class UpdateCallback {
  ...
  protected static long getCPtr(UpdateCallback paramUpdateCallback) {
    return (paramUpdateCallback == null) ? 0L : paramUpdateCallback.swigCPtr;
  }
  ...
  protected void delete() {
    ...
    //   27: invokestatic delete_UpdateCallback : (J)V
    //   30: aload_0
    //   31: lconst_0
  ...
  public boolean equals(Object paramObject) {
    boolean bool = paramObject instanceof UpdateCallback;
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (bool) {
      bool1 = bool2;
      if (((UpdateCallback)paramObject).swigCPtr == this.swigCPtr)
        bool1 = true; 
    } 
    return bool1;
  }
...
/* Location:              C:\Users\Student\Desktop\APK Decompiling\com.qualcomm.ftcdriverstation_38_apps.evozi.com\classes-dex2jar.jar!\com\vuforia\UpdateCallback.class
